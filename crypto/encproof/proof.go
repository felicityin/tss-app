// Reference https://github.com/alexSmallWorld/alice-ed25519/blob/master/crypto/zkproof/paillier/encrangezkproof.go
...
func NewEncryptRangeMessage(
	...
	e, salt, err := pailliera.GetE(groupOrder, utils.GetAnyMsg(ssidInfo, new(big.Int).SetUint64(config.LAddEpsilon).Bytes(),
